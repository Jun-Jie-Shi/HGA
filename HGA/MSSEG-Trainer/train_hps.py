...
parser.add_argument('--savepath', default='outputs/idt_mr97531_hps_bs4_epoch300_lr2e-4_temp4_seed3407', type=str)
...
def main():
    ...
    for epoch in range(args.num_epochs):
        ...
        for i in range(iter_per_epoch):
            ...
            # losses = criterions.softmax_weighted_loss(torch.nn.Softmax(dim=1)(out_bs[5]), target, num_cls=num_cls)
            # #  criterions.DiceCoef2(out_bs[5], target, num_cls=num_cls) + + criterions.softmax_weighted_loss(torch.nn.Softmax(dim=1)(out_bs[5]), target, num_cls=num_cls)
