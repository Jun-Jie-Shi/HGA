...
parser.add_argument('--savepath', default='outputs/idt_mr97531_uw_hgda_bs4_epoch300_lr2e-4_temp4_seed3407', type=str)
...
def main():
    ...
    uw_adam = UncertaintyWeight(optimizer, n_tasks=5, writer=writer)
    temp = args.temp
    ##########Setting data
        ####BRATS2020
