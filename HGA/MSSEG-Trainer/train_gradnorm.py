...
parser.add_argument('--savepath', default='outputs/idt_mr97531_gradnorm_hga_bs4_epoch300_lr2e-4_temp4_seed1038', type=str)
...
def main():
    ...
    gn_adam = GradNorm(optimizer, n_tasks=5, writer=writer)
    temp = args.temp
    ##########Setting data
        ####BRATS2020
