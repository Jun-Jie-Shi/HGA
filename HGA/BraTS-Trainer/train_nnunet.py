...
from models import rfnet_passionv2, mmformer, m2ftrans_passionv2, mmformer_ce, mmformer_gss, nnunet
...
def main():
    ...
    elif args.model == 'mmformer_ce':
        model = mmformer_ce.Model(num_cls=num_cls)
