...
from models import mmformer_pk_4

from torch.utils.data import DataLoader
from torch.utils.tensorboard import SummaryWriter
from utils import criterions
from utils.predict import AverageMeter, test_ece_softmax, test_dice_hd95_softmax
...
parser.add_argument('--model', default='mmformer', type=str)
parser.add_argument('-batch_size', '--batch_size', default=1, type=int, help='Batch size')
parser.add_argument('--lr', default=2e-4, type=float)
parser.add_argument('--weight_decay', default=1e-4, type=float)
parser.add_argument('--num_epochs', default=1000, type=int)
# parser.add_argument('--iter_per_epoch', default=150, type=int)
parser.add_argument('--dataname', default='BraTS/BRATS2023', type=str)
parser.add_argument('--datapath', default='BraTS/BRATS2023_Training_none_npy', type=str)
parser.add_argument('--savepath', default='outputs/eval_2023_passion', type=str)
parser.add_argument('--resume', default='/home/sjj/MMMSeg/LongTail/exp/out/1379_mmformer_pk_4_protop2_klimbprotora_AdamW_nosplit_longtail_seed3407_batchsize1_epoch300_lr2e-4_temp4/model_last.pth', type=str)
...
def main():
    ...
    if args.model == 'mmformer':
        model = mmformer_pk_4.Model(num_cls=num_cls)
