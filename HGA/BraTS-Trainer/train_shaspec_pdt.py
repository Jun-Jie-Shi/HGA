...
def main():
    ...
    if args.model == 'mmformer':
        ...
        model = DualNet_SS.DualNet_SS2(args=args, norm_cfg='IN', activation_cfg='LeakyReLU',
    ...
    if args.use_passion:
        ...
        for epoch in range(args.num_epochs):
            ...
            for i in range(iter_per_epoch):
                ...
                preds, shared_info, spec_info, mode_split = model(x, mask)
                # losses = []
                # losses_summary = []
                ...
                loss = term_seg_Dice + term_seg_BCE + 0.1 * term_shared + 0.02 * term_spec
