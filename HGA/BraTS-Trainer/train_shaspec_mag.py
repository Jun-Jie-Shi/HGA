    ...
    if args.use_passion:
        ...
        for epoch in range(args.num_epochs):
            ...
            for i in range(iter_per_epoch):
                ...
                kl_loss_m = torch.sum(kl_loss, dim=0)
                # term_kl = kl_loss_m.sum()

                fkl0 = torch.nn.L1Loss()(fe0, fep)
                fkl1 = torch.nn.L1Loss()(fe1, fep)
                fkl2 = torch.nn.L1Loss()(fe2, fep)
                fkl3 = torch.nn.L1Loss()(fe3, fep)
                ...
                loss = term_seg_Dice + term_seg_BCE + 0.1 * term_shared + 0.02 * term_spec + 0.5 * term_kl + 0.01 * term_fkl
