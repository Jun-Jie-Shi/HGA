...
class GradNorm:
    ...
    def step(self):
        ...
        logging.info('Modality Weights:[{:.4f},{:.4f},{:.4f},{:.4f}]'.format(self.task_weights[0].item(),self.task_weights[1].item(),self.task_weights[2].item(),self.task_weights[3].item()))
        return
    ...
    def gradnorm_backward(self, objectives, loss_fuse=None, active_tasks=None):
        """
