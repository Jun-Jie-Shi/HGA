...
class Model(nn.Module):
    ...
    def forward(self, x, mask, target=None, temp=1.0):
        ...
        de_f_avg=de_f_avg[0].mean(dim=(-1,-2,-3))
        de_f_flair=de_f_flair[0].mean(dim=(-1,-2,-3))
        de_f_t1ce=de_f_t1ce[0].mean(dim=(-1,-2,-3))
        de_f_t1=de_f_t1[0].mean(dim=(-1,-2,-3))
        de_f_t2=de_f_t2[0].mean(dim=(-1,-2,-3))

        vis_ft = torch.cat([de_f_avg, de_f_flair, de_f_t1ce, de_f_t1, de_f_t2])
