...
from utils.criterions import temp_kl_loss, softmax_weighted_loss, dice_loss, prototype_loss, prototype_kl_loss_4
    ...
    def forward(self, x, mask, target=None, temp=1.0):
        ...
        if self.is_training:
            ...
            if mask[0,0]:
                ...
                proto_loss[0], fkl_loss[0] = prototype_kl_loss_4(de_f_flair[0], de_f_avg[0].detach(), target, fuse_pred_flair, fuse_pred.detach(), num_cls=num_cls, temp=temp)
            ...
            if mask[0,1]:
                ...
                proto_loss[1], fkl_loss[1] = prototype_kl_loss_4(de_f_t1ce[0], de_f_avg[0].detach(), target, fuse_pred_t1ce, fuse_pred.detach(), num_cls=num_cls, temp=temp)
            ...
            if mask[0,2]:
                ...
                proto_loss[2], fkl_loss[2] = prototype_kl_loss_4(de_f_t1[0], de_f_avg[0].detach(), target, fuse_pred_t1, fuse_pred.detach(), num_cls=num_cls, temp=temp)
            ...
            if mask[0,3]:
                ...
                proto_loss[3], fkl_loss[3] = prototype_kl_loss_4(de_f_t2[0], de_f_avg[0].detach(), target, fuse_pred_t2, fuse_pred.detach(), num_cls=num_cls, temp=temp)
