...
from utils.criterions import temp_kl_loss, softmax_weighted_loss, dice_loss, prototype_passion_loss_bs
        ...
        if self.is_training:
            if self.mask_type == 'pdt':
                ...
                if mask[0,0]:
                    ...
                    proto_loss[0], dist[0] = prototype_passion_loss_bs(de_f_flair[0], de_f_avg[0].detach(), target, fuse_pred_flair, fuse_pred.detach(), num_cls=num_cls, temp=temp)
                ...
                if mask[0,1]:
                    ...
                    proto_loss[1], dist[1] = prototype_passion_loss_bs(de_f_t1ce[0], de_f_avg[0].detach(), target, fuse_pred_t1ce, fuse_pred.detach(), num_cls=num_cls, temp=temp)
                ...
                if mask[0,2]:
                    ...
                    proto_loss[2], dist[2] = prototype_passion_loss_bs(de_f_t1[0], de_f_avg[0].detach(), target, fuse_pred_t1, fuse_pred.detach(), num_cls=num_cls, temp=temp)
                ...
                if mask[0,3]:
                    ...
                    proto_loss[3], dist[3] = prototype_passion_loss_bs(de_f_t2[0], de_f_avg[0].detach(), target, fuse_pred_t2, fuse_pred.detach(), num_cls=num_cls, temp=temp)
