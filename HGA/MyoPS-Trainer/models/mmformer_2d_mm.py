    ...
    def forward(self, x, mask, target=None, temp=1.0):
        ...
        if self.is_training:
            ...
            if mask[0,0]:
                ...
                proto_loss[0], fkl_loss[0] = prototype_kl_loss(de_f_bssfp[0], de_f_avg[0].detach(), target, fuse_pred_bssfp, fuse_pred.detach(), num_cls=num_cls, temp=temp)
            ...
            if mask[0,1]:
                ...
                proto_loss[1], fkl_loss[1] = prototype_kl_loss(de_f_lge[0], de_f_avg[0].detach(), target, fuse_pred_lge, fuse_pred.detach(), num_cls=num_cls, temp=temp)
            ...
            if mask[0,2]:
                ...
                proto_loss[2], fkl_loss[2] = prototype_kl_loss(de_f_t2[0], de_f_avg[0].detach(), target, fuse_pred_t2, fuse_pred.detach(), num_cls=num_cls, temp=temp)
