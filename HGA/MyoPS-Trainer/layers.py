...
class general_conv3d_prenorm_2d(nn.Module):
    def __init__(self, in_ch, out_ch, k_size=(3,3,1), stride=1, padding=(1,1,0), pad_type='zeros', norm='in', is_training=True, act_type='lrelu', relufactor=0.2):
        super(general_conv3d_prenorm_2d, self).__init__()
...
class fusion_prenorm_2d(nn.Module):
    def __init__(self, in_channel=64, num_modals=3):
        super(fusion_prenorm_2d, self).__init__()
        self.fusion_layer = nn.Sequential(
                        general_conv3d_prenorm_2d(in_channel*num_modals, in_channel, k_size=1, padding=0, stride=1),
                        general_conv3d_prenorm_2d(in_channel, in_channel, k_size=(3,3,1), padding=(1,1,0), stride=1),
                        general_conv3d_prenorm_2d(in_channel, in_channel, k_size=1, padding=0, stride=1))
