...
If you want to divide data by yourself, `data_split.py` and `generate_imb_mr.py` in the `BraTS-Trainer/preprocessing` folder is available. (if you want to use other datasets, just do it similarly)
